Feature: Gerenciar Filmes no RottenPotatoes

1. Try to add nonexistent movie (sad path)   
...
Scenario: View movie list after adding 2 movies (Imperative) 
    ...
    Given I have added the movie "Zorro" with rating "PG"

    And I have added the movie "Apocalypse Now" with rating "R"
